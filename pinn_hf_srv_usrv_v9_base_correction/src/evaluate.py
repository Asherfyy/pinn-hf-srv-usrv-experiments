...
from .losses import compute_dirichlet_loss, compute_interface_loss, compute_pde_loss
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="生成 v9 base-correction partitioned-MLP 诊断表。")
