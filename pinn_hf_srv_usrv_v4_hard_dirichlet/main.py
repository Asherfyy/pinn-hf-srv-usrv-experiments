"""Unified entrypoint for the v4 hard-Dirichlet partitioned-MLP PINN project."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="v4 hard-Dirichlet partitioned-MLP HF/SRV/USRV PINN entrypoint.")
