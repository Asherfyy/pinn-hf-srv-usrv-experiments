...
from .physics import dimensionless_pde_coefficients, interface_residual, line_hf_srv_residual, neumann_normal_derivative, pde_residual
...
def compute_interface_loss(
    ...
    if getattr(geometry, "hf_as_line", False):
