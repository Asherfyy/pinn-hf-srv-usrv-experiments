"""Unified entrypoint for the v6 mixed-flux partitioned-MLP PINN project."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="v6 mixed-flux partitioned-MLP HF/SRV/USRV PINN entrypoint.")
