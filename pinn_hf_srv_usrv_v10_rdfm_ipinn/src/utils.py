...
PROJECT_VERSION = "rdfm_ipinn_v10"
...
def get_torch_dtype(dtype_name: str) -> torch.dtype:
    """Convert the configured dtype string to the torch dtype used by v10."""

    if str(dtype_name).lower() != "float32":
        raise ValueError(f"v10 only supports float32, got dtype={dtype_name}.")
