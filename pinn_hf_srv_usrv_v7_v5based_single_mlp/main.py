"""Unified entrypoint for the v7 base-correction single-MLP PINN project."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="v7 base-correction single-MLP HF/SRV/USRV PINN entrypoint.")
